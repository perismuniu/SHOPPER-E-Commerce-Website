...
const Hero = () => {
  return (
    <div className="min-h-screen min-w-screen bg-orange-50 mt-0 bg-cover font-Poppins flex justify-around item-center">
        ...
        <div>
            <img className="flex items-centerjustify-center flex-1 h-auto w-96 mt-24" src={hero_image} alt=""/>
        </div>
